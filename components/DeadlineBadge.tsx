  ...
  const colorClass =
    remaining <= 0
      ...
      : hoursLeft < 24
        ...
        : "bg-status-good/15 text-status-good border-status-good/40";

  return (
    <div className="flex flex-col gap-0.5">
      <span
        className={`inline-block w-fit rounded-full border px-2 py-0.5 text-xs font-semibold tabular-nums ${colorClass}`}
      >
